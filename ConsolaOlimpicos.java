...
public class ConsolaOlimpicos
{
	...
	private void ejecutarAtletasPais()
	{
		System.out.println("\n" + "Pais al que pertenece el Atleta" + "\n");

		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		Map<String, List<Atleta>> atletas = calculadora.Atletaspais(pais);
		System.out.println("El atelta pertenece a " + atletas);
		for (String pais : atletas.keySet())
		{
			System.out.println(pais + ": " + atletas.get(pais));
		}
	}
	/**
